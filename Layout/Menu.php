<div class="container1">
    ...
    <div class="hamburger-menu">
        ...
        <ul class="menu__box">
            ...
            <li><a class="menu__item" href="../Project/Project.php"><i class="fas fa-user-circle"></i> Projets</a></li>
            <li><a class="menu__item" href="../Project/InsertProject.php"><i class="fas fa-user-circle"></i> Ajouter un Projets</a></li>
