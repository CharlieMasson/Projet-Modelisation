<?php
    ...
    $myArray = HostRepository::initializeArray();
    $myHost = new Host($id, "", "", "");
    ...
    if(!empty($_POST)) {
        ...
        $myArray = HostRepository::deleteHost($id);
    }
...
<html>
    <head>
        <title> Supprimer un Hébergeur </title>
        <meta charset="utf-8"/>
    ...
    <?php include '../Layout/Menu.php'; ?>
        ...
        <h1 class="text-logo"> Hébergeur </h1>
        <div class="container admin">
            <div class="row">
                <h1><strong> Supression d'un Hébergeur </strong></h1>
                <br>
                <form class="form" role="form" method="post">
                    ...
                    if (empty($_POST)){
                        ...
                        echo "<p> Voulez-Vous vraiment supprimer l'hébergeur " . $myHost->getName() . " ? Cette action est définitive. </p>";
                        echo "<div class='form-actions'>";
                        echo "<button type='submit' class='btn btn-danger'> Supprimer </button> <a class='btn btn-secondary btnAnnuler' href='Host.php'> Annuler </a>";
                        echo "</div>";
                        ...
                        if ($myArray['isSuccess'] == 0){
                            ...
                            echo "<br>";
                            echo "Hébergeur supprimé avec succès.";
                            echo "<a class='btn btn-warning' href='Host.php'> Retour </a>";
